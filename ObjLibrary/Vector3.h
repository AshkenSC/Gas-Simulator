...
//           3x3 matrix expressed as the specified Vector3s.
//           The Vector3s correspond to the X, Y, and Z vectors
//           of a basis matrix.
//  Parameter(s):
//    <1> v1                           +------+------+------+
//    <2> v2                           | v1.x | v1.y | v1.z |
//    <3> v3: The matrix elements      +------+------+------+
//  Precondition(s):                   | v2.x | v2.y | v2.z |
//    <1> isFinite()                   +------+------+------+
//    <2> v1.isFinite()                | v3.x | v3.y | v3.z |
//    <3> v2.isFinite()                +------+------+------+
//    <4> v3.isFinite()
//  Returns: A copy of this Vector3 multiplied by the matrix
//           composed of the 9 elements in v1, v2, and v3.
//  Side Effect: N/A
//

	Vector3 getMatrixProduct (const Vector3& v1,
	                          const Vector3& v2,
